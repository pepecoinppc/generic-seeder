...
### Pepecoin testnet DNS Seeder

This branch is set up to seed the Pepecoin testnet. All you have to do is follow the guide below to build from source. In this branch, the settings.conf is all set up for you.
